...
export const analyticsTypeDefs = gql`
  type Query {
    ...
    getJobTagRankingByDateRange(startDate: Date, endDate: Date): [JobTagRanking]
    ...
    getJobLocationRankingByDateRange(startDate: Date, endDate: Date): [JobLocationRanking]
    getJobTypeRanking: [JobTypeRanking]
    getJobTypeRankingByDateRange(startDate: Date, endDate: Date): [JobTypeRanking]
    getJobDeadlineRankingByMonth: [JobDeadlineRanking]
    getJobDeadlineRankingByMonthWithDateRange(startDate: Date, endDate: Date): [JobDeadlineRanking]
    ...
    getNumJobPostsWithDateRange(startDate: Date, endDate: Date): Int
    getNumActiveJobsWithDateRange(startDate: Date, endDate: Date): Int
  }
