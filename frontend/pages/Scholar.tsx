...
export default function Scholar() {
  ...
  if (
    (scholarData.getScholarByEmail === null || scholarData === undefined) &&
    !loadingScholar
  ) {
  ...
  return (
    <div>
      {scholarData.getScholarByEmail === null ? (
        <Loading />
      ) : (
        <div>
          <Navbar />
          <SearchBar />
          <ScholarHero
            employerData={newestEmployers}
            employerLoading={loadingEmployers}
          />
