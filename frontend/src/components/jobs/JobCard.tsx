      ...
      <div className={styles.jobCard}>
        <div>
          <div className={styles.jobCardHeader}>
            ...
            >
              <h3 style={{ padding: 0, margin: 0, marginBottom: "0.4rem" }}>
                {job.title}
              </h3>
          ...
          <div className={styles.jobCardBody} onClick={() => handleJobClick}>
          ...
          <p className={styles.deadline}>
            {check > 2090 ? "No Deadline" : "Deadline: " + date}
          </p>
        </div>
        {archive ? null : (
          <Bookmarked
      ...
      {email ? null : (
        ...
        >
          ...
          <div className={styles.jobCardBodyDrawer}>
            ...
            {job.contact_email ? (
              <h4>{"Contact: " + job.contact_email}</h4>
            ) : null}
            {job.additional_info ? (
              <div>
...
const Bookmarked = (props: any) => {
  ...
  return (
    ...
    >
      {bookmarked ? (
        <FaBookmark size={24} color="#806E53" />
      ) : (
...
const formatText = (text: string) => {
  ...
  let final = result.map((str: string, index: number) => {
    if (str.includes("- ") || str.startsWith("\n-\t" || str.startsWith("- "))) {
      ...
      return (
        <div key={index}>
          <h4 style={{ fontWeight: "bold", fontSize: "16" }}>{str}</h4>
        </div>
      );
    }
  });
