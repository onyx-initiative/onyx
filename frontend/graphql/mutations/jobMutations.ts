...
mutation createJob($employerId: ID!, $adminId: ID!, $title: String!, $description: String!, $jobType: String!, $term: String!, $location: String!, $applicantYear: [Int!]!, $deadline: String!, $tags: [String!]!, $contactEmail: String, $longDescription: String) {
    createJob(employer_id: $employerId, admin_id: $adminId, title: $title, description: $description, job_type: $jobType, term: $term, location: $location, applicantYear: $applicantYear, deadline: $deadline, tags: $tags, contact_email: $contactEmail, long_description: $longDescription)
  }
  `
